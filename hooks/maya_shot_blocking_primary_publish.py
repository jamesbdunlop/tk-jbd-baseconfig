...
class PrimaryPublishHook(Hook):
    ...
    def _do_maya_publish(self, task, work_template, comment, thumbnail_path, sg_task, progress_cb):
        ...
        debug(None, method = '_do_maya_publish', message = 'dependencies: %s' % dependencies, verbose = True)    
        ## Get scene path
        scene_path = os.path.abspath(cmds.file(query=True, sn= True))
        debug(None, method = '_do_maya_publish', message = 'scene_path: %s' % scene_path, verbose = True)
        ...
        if os.path.exists(publish_path):
            debug(None, method = '_do_maya_publish', message = 'Publish path exists! Altering file v# now', verbose = True)
            ...
            debug(None, method = '_do_maya_publish', message = 'path: %s' % path, verbose = True)
            ...
            debug(None, method = '_do_maya_publish', message = 'NEW publish_path: %s' % publish_path, verbose = True)
        ...
        debug(None, method = '_do_maya_publish', message = 'Saved scene to %s.v%s%s' % (publish_name, padding, fields['version']), verbose = True)
        ...
        try:
            ...
            debug(None, method = '_do_maya_publish', message = 'publish_folder: %s' % publish_folder, verbose = True)
            ...
            debug(None, method = '_do_maya_publish', message = "Publishing %s --> %s..." % (getCurrentScenePath, publish_path), verbose = True)
        ...
        print
        debug(None, method = '_do_maya_publish', message = "publish_path: %s" % publish_path, verbose = True)
        debug(None, method = '_do_maya_publish', message = "publishName: %s_LAYOUT" % publish_name, verbose = True)
        debug(None, method = '_do_maya_publish', message = "sg_task: %s" % sg_task, verbose = True)
        debug(None, method = '_do_maya_publish', message = "publish_version: %s" % fields["version"], verbose = True)
        debug(None, method = '_do_maya_publish', message = "tank_type: %s" % output["tank_type"], verbose = True)
        debug(None, method = '_do_maya_publish', message = "comment: %s" % comment, verbose = True)
        debug(None, method = '_do_maya_publish', message = "thumbnail_path: %s" % thumbnail_path, verbose = True)
        debug(None, method = '_do_maya_publish', message = "dependencies: %s" % dependencies, verbose = True)
    ...
    def _register_publish(self, path, name, sg_task, publish_version, tank_type, comment, thumbnail_path, dependency_paths):
        ...
        """
        debug(None, method = '_register_publish', message = "path: %s" % path, verbose = True)
        debug(None, method = '_register_publish', message = "name: %s" % name, verbose = True)
        debug(None, method = '_register_publish', message = "sg_task: %s" % sg_task, verbose = True)
        debug(None, method = '_register_publish', message = "publish_version: %s" % publish_version, verbose = True)
        debug(None, method = '_register_publish', message = "tank_type: %s" % tank_type, verbose = True)
        debug(None, method = '_register_publish', message = "comment: %s" % comment, verbose = True)
        debug(None, method = '_register_publish', message = "thumbnail_path: %s" % thumbnail_path, verbose = True)
        debug(None, method = '_register_publish', message = "dependency_paths: %s" % dependency_paths, verbose = True)
        ...
        debug(None, method = '_register_publish', message = "args: %s" %  str(args), verbose = True)
        debug(None, method = '_register_publish', message = "Registering the publish now...", verbose = True)
        # register publish;
