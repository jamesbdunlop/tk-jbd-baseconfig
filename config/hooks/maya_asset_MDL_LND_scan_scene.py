...
class ScanSceneHook(Hook):
    ...
    def execute(self, **kwargs):
        ...
        ## Now cleanup
        asset_lib.cleanUp(items = items, checkShapes = True, history = True, pivots = False, freezeXFRM = False, smoothLvl = False, tagSmoothed = True, checkVerts = False,
                        renderflags = True, deleteIntermediate = True, turnOffOpposite = True, instanceCheck = True, shaders = True, removeNS = True, coreArchives = True)
